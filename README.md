...
- `/settings/events` — Конструктор событий: 8 слотов правил, заводское правило 5 быстрых нажатий тормоза, безопасные действия света/звука/PAS и сервисный ограничитель газа. Изменения применяются сразу; раздел `events` входит в экспорт/импорт настроек.
