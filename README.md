...
- **WiFi & Web-интерфейс:**
  ...
  - OTA-обновление прошивки по воздуху (`v0.1.5-alpha`) без кабеля (`/update`).
...
- **`bike_prototype_simple.ino`** — Оптимизированная стабильная версия: throttle-by-wire с PAS, приоритет тормоза, свет/звук передней группы, WiFi-настройки, телеметрия. **Текущая версия: v0.1.5-alpha**
