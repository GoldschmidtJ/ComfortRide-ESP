...
- **`src/main.cpp`** — единственная актуальная прошивка PlatformIO, версия **v0.3.1**: throttle-by-wire, PAS, приоритет тормоза, свет/звук, WiFi-настройки, телеметрия и OTA.
